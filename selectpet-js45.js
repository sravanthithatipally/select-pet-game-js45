...
let selectele = document.getElementById("petSelect");
let imageele = document.getElementById("petImg");

function optionchanged(event) {
    let imagename = event.target.value;
    imageele.setAttribute("src", petsImageUrls[imagename]);

}
selectele.addEventListener("change", optionchanged);